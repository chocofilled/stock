document.addEventListener('DOMContentLoaded', () => {
  ...
  const RETRO_THEMES = [
    { id: 'semicon', name: '반도체', stocks: ['005930', '000660', '000990', '042700', '403870'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="3" y="3" width="10" height="10" fill="#3a3d52"/><rect x="5" y="5" width="6" height="6" fill="#1b1e2c"/><rect x="7" y="7" width="2" height="2" fill="#00ffcc"/><rect x="5" y="1" width="2" height="2" fill="#ffe600"/><rect x="9" y="1" width="2" height="2" fill="#ffe600"/><rect x="5" y="13" width="2" height="2" fill="#ffe600"/><rect x="9" y="13" width="2" height="2" fill="#ffe600"/><rect x="1" y="5" width="2" height="2" fill="#ffe600"/><rect x="1" y="9" width="2" height="2" fill="#ffe600"/><rect x="13" y="5" width="2" height="2" fill="#ffe600"/><rect x="13" y="9" width="2" height="2" fill="#ffe600"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#3b695e" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="10" height="10" rx="1"/><path d="M5.5 1v2M10.5 1v2M5.5 13v2M10.5 13v2M1 5.5h2M1 10.5h2M13 5.5h2M13 10.5h2"/></svg>` },
    { id: 'ai', name: 'AI/클라우드', stocks: ['035420', '035720', '030200', '032640', '017670'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="5" y="2" width="6" height="6" fill="#bd00ff"/><rect x="4" y="4" width="8" height="3" fill="#bd00ff"/><rect x="6" y="1" width="4" height="1" fill="#bd00ff"/><rect x="7" y="4" width="2" height="2" fill="#ffffff"/><rect x="6" y="8" width="4" height="2" fill="#777788"/><rect x="7" y="10" width="2" height="1" fill="#ffe600"/><rect x="2" y="5" width="2" height="1" fill="#00ffcc"/><rect x="12" y="5" width="2" height="1" fill="#00ffcc"/><rect x="8" y="12" width="1" height="2" fill="#00ffcc"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#46658a" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5.5 11.5a2.5 2.5 0 0 1 .5-4.9 3 3 0 0 1 5.6-1.1 2.5 2.5 0 0 1 1.9 4.5 1 1 0 0 1-.5 1.5H5.5z"/></svg>` },
    { id: 'game', name: '게임/엔터', stocks: ['259960', '251270', '036570', '352820', '041510'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="1" y="4" width="14" height="8" fill="#555566"/><rect x="2" y="5" width="12" height="6" fill="#1b1e2c"/><rect x="4" y="7" width="3" height="2" fill="#ffffff"/><rect x="5" y="6" width="1" height="4" fill="#ffffff"/><rect x="10" y="8" width="2" height="2" fill="#ff0055"/><rect x="12" y="6" width="2" height="2" fill="#ff0055"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#8c4755" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="12" height="8" rx="2"/><circle cx="5" cy="8" r="1"/><circle cx="11" cy="7" r="0.8"/><circle cx="11" cy="9" r="0.8"/></svg>` },
    { id: 'finance', name: '금융/은행', stocks: ['105560', '055550', '138040', '086790', '316140'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="4" y="2" width="8" height="12" fill="#ffe600"/><rect x="2" y="4" width="12" height="8" fill="#ffe600"/><rect x="3" y="3" width="10" height="10" fill="#ffaa00"/><rect x="5" y="4" width="6" height="8" fill="#ffe600"/><rect x="7" y="5" width="2" height="6" fill="#111424"/><rect x="6" y="6" width="4" height="1" fill="#111424"/><rect x="6" y="9" width="4" height="1" fill="#111424"/><rect x="7" y="3" width="1" height="10" fill="#111424"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#877048" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M1.5 13.5h13M2.5 5.5h11M3.5 5.5v8M8 5.5v8M12.5 5.5v8M8 2L2.5 5.5h11L8 2z"/></svg>` },
    { id: 'bio', name: '제약/바이오', stocks: ['207940', '068270', '000100', '128940', '196170'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="3" y="4" width="10" height="9" fill="#111424" opacity="0.3"/><rect x="3" y="9" width="4" height="4" fill="#ffffff"/><rect x="4" y="8" width="4" height="4" fill="#ffffff"/><rect x="5" y="7" width="4" height="4" fill="#ffffff"/><rect x="7" y="5" width="4" height="4" fill="#ff0055"/><rect x="8" y="4" width="4" height="4" fill="#ff0055"/><rect x="9" y="3" width="4" height="4" fill="#ff0055"/><rect x="11" y="4" width="1" height="1" fill="#ffffff"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#447356" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 3S9.5 2.5 6.5 5.5C4 8 3.5 12.5 3.5 12.5s4.5-.5 7-3c3-3 2.5-6.5 2.5-6.5zM3.5 12.5l3.5-3.5"/></svg>` },
    { id: 'car', name: '자동차', stocks: ['005380', '000270', '012330', '018880', '011210'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="2" y="7" width="12" height="4" fill="#ff0055"/><rect x="4" y="5" width="7" height="2" fill="#ff0055"/><rect x="7" y="5" width="3" height="2" fill="#00ffcc"/><rect x="3" y="10" width="3" height="3" fill="#111424"/><rect x="10" y="10" width="3" height="3" fill="#111424"/><rect x="4" y="11" width="1" height="1" fill="#ffe600"/><rect x="11" y="11" width="1" height="1" fill="#ffe600"/><rect x="1" y="6" width="2" height="2" fill="#ffffff"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#945844" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 9.5h14M3.5 6.5l1.5-3h6l1.5 3M1.5 9.5v3h13v-3M4.5 12.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2zM11.5 12.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/></svg>` },
    { id: 'energy', name: '에너지', stocks: ['034020', '015760', '267260', '298040', '010120'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="8" y="1" width="2" height="2" fill="#ffe600"/><rect x="7" y="3" width="3" height="2" fill="#ffe600"/><rect x="6" y="5" width="4" height="2" fill="#ffe600"/><rect x="4" y="7" width="9" height="2" fill="#ffe600"/><rect x="6" y="9" width="4" height="2" fill="#ffe600"/><rect x="5" y="11" width="3" height="2" fill="#ffe600"/><rect x="4" y="13" width="2" height="2" fill="#ffe600"/><rect x="1" y="7" width="2" height="2" fill="#00ffcc"/><rect x="13" y="6" width="2" height="2" fill="#00ffcc"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#99643d" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><polygon points="9.5 1.5 3.5 8.5 7.5 8.5 6.5 14.5 12.5 7.5 8.5 7.5 9.5 1.5"/></svg>` },
    { id: 'battery', name: '2차전지', stocks: ['373220', '086520', '003670', '005490', '006400'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="7" y="1" width="2" height="1" fill="#ffffff"/><rect x="4" y="2" width="8" height="13" fill="#ffffff"/><rect x="5" y="3" width="6" height="11" fill="#1b1e2c"/><rect x="6" y="4" width="4" height="9" fill="#00ffcc"/><rect x="7" y="6" width="2" height="2" fill="#ffe600"/><rect x="6" y="8" width="2" height="2" fill="#ffe600"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#3b786d" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="3.5" width="9" height="10" rx="1"/><path d="M6.5 1.5h3v2h-3zM8 5.5v6M6 8.5h4"/></svg>` },
    { id: 'robot', name: '로보틱스', stocks: ['454910', '277810', '348210', '090470', '214150'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="7" y="1" width="2" height="2" fill="#ffe600"/><rect x="7" y="3" width="2" height="3" fill="#ffffff"/><rect x="3" y="6" width="10" height="8" fill="#777788"/><rect x="4" y="7" width="8" height="6" fill="#555566"/><rect x="2" y="9" width="1" height="2" fill="#ffffff"/><rect x="13" y="9" width="1" height="2" fill="#ffffff"/><rect x="5" y="8" width="2" height="2" fill="#00ffcc"/><rect x="9" y="8" width="2" height="2" fill="#00ffcc"/><rect x="6" y="11" width="4" height="1" fill="#ff0055"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#6f4d8a" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="10" height="8" rx="1"/><circle cx="6" cy="8.5" r="0.8"/><circle cx="10" cy="8.5" r="0.8"/><path d="M6 11h4M8 1v4"/></svg>` },
    { id: 'food', name: 'K-푸드', stocks: ['003230', '004370', '007310', '097950', '017810'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="2" y="7" width="12" height="6" fill="#ff0055"/><rect x="3" y="13" width="10" height="1" fill="#ff0055"/><rect x="4" y="14" width="8" height="1" fill="#ff0055"/><rect x="3" y="6" width="10" height="1" fill="#ffe600"/><rect x="4" y="9" width="2" height="2" fill="#ffffff"/><rect x="10" y="9" width="2" height="2" fill="#ffffff"/><rect x="11" y="2" width="4" height="1" fill="#ffe600"/><rect x="9" y="3" width="3" height="1" fill="#ffe600"/><rect x="7" y="4" width="3" height="1" fill="#ffe600"/><rect x="5" y="5" width="3" height="1" fill="#ffe600"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#876340" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M1.5 8.5c0 3.3 2.7 6 6 6s6-2.7 6-6H1.5zM5 2.5a3 3 0 0 1 1 2.5M8 1.5a3 3 0 0 1 1 3.5M11 2.5a3 3 0 0 1 1 2.5"/></svg>` },
    { id: 'beauty', name: '화장품', stocks: ['090430', '192820', '161890', '278470', '214420'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="5" y="8" width="6" height="7" fill="#1b1e2c" stroke="#ffffff" stroke-width="1"/><rect x="6" y="9" width="4" height="1" fill="#ffe600"/><rect x="6" y="5" width="4" height="3" fill="#ff0055"/><rect x="6" y="4" width="3" height="1" fill="#ff0055"/><rect x="6" y="3" width="2" height="1" fill="#ff0055"/><rect x="8" y="5" width="1" height="2" fill="#ffffff"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#8a4d75" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="6.5" width="9" height="8" rx="1"/><rect x="5.5" y="2.5" width="5" height="4" rx="0.5"/></svg>` },
    { id: 'defense', name: '방산', stocks: ['012450', '079550', '064350', '047810', '103140'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="2" y="8" width="12" height="4" fill="#777788"/><rect x="3" y="12" width="10" height="2" fill="#111424"/><rect x="5" y="5" width="6" height="3" fill="#777788"/><rect x="10" y="3" width="4" height="2" fill="#ffe600"/><rect x="9" y="4" width="2" height="2" fill="#777788"/><rect x="4" y="12" width="1" height="1" fill="#ffffff"/><rect x="7" y="12" width="1" height="1" fill="#ffffff"/><rect x="10" y="12" width="1" height="1" fill="#ffffff"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#606b46" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 1.5s5.5 1.5 5.5 5.5c0 4-4 6.5-5.5 7.5-1.5-1-5.5-3.5-5.5-7.5 0-4 5.5-5.5 5.5-5.5zM8 4.5v6.5"/></svg>` },
    { id: 'ship', name: '조선/중공업', stocks: ['329180', '010140', '042660', '009540', '443060'], icon: `<svg class="theme-icon" viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><rect x="0" y="13" width="16" height="3" fill="#00aaff"/><rect x="2" y="12" width="12" height="1" fill="#00ffcc"/><rect x="2" y="9" width="12" height="3" fill="#555566"/><rect x="1" y="8" width="12" height="1" fill="#ff0055"/><rect x="3" y="5" width="5" height="3" fill="#ffffff"/><rect x="5" y="4" width="2" height="1" fill="#ffffff"/><rect x="4" y="6" width="1" height="1" fill="#00ffcc"/><rect x="6" y="6" width="1" height="1" fill="#00ffcc"/><rect x="9" y="3" width="1" height="10" fill="#ffffff" opacity="0.6"/><rect x="10" y="1" width="2" height="2" fill="#ffffff" opacity="0.4"/></svg>`, modernIcon: `<svg class="theme-icon modern-icon" viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="#366f7d" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M1.5 10.5l1 3.5h11l1-3.5H1.5zM8 1.5v9M8 3.5c-2.5 0-4 2-4 2s1.5 1 4 1"/></svg>` }
  ];
  ...
  async function loadThemeBoard() {
    ...
    if (themeBoard.children.length === 0) {
      ...
      RETRO_THEMES.forEach((theme) => {
        ...
        const pixelIconHtml = theme.icon.replace('class="theme-icon"', 'class="theme-icon pixel-icon"');
        const modernIconHtml = theme.modernIcon;
        iconContainer.innerHTML = pixelIconHtml + modernIconHtml;
